...
describe("useBooksQuery", () => {
  ...
  it("should handle book deletion with pagination", async () => {
    ...
    (booksService.deleteBook as jest.Mock).mockImplementation(
      async (_: string) => {
  ...
  it("should handle book status change with pagination", async () => {
    ...
    (booksService.updateBook as jest.Mock).mockImplementation(
      async (bookId: string, updatedBook: Partial<Book>) => {
  ...
  it("should handle errors gracefully with pagination", async () => {
    ...
    (booksService.getUserBooksDataPaginated as jest.Mock).mockRejectedValue(
      error,
    );
  ...
  it("toggles favorite status correctly with pagination", async () => {
    ...
    expect(booksService.updateBook).toHaveBeenCalledWith(bookId, {
  ...
  it("should support pagination controls", async () => {
    ...
    const nextPageBooks = [{ ...mockBooks[0], id: "2", title: "Second Book" }];

    (
      booksService.getUserBooksDataPaginated as jest.Mock
